...
export const CodeBlock = ({
  ...
  // Map prisma to typescript for proper syntax highlighting
  const getHighlightLanguage = (lang: string) => {
    if (lang === 'prisma') return 'typescript';
    return lang;
  };
  ...
  return (
    <div className="relative w-full rounded-lg bg-black p-4 font-mono text-sm">
      ...
      <SyntaxHighlighter
        language={getHighlightLanguage(activeLanguage)}
        style={customTheme}
        customStyle={{
          margin: 0,
          padding: 0,
        ...
        lineNumberStyle={{
          color: "#6b7280", // Line number color
          minWidth: "2.5em",
          paddingRight: "1em",
          textAlign: "right",
          userSelect: "none",
