...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      {/* Floating tool logos - positioned around the register component */}
      <div className="absolute inset-0">
        {/* MongoDB - top left of register */}
        ...
        {/* TypeScript - top right of register */}
        ...
        {/* PostgreSQL - right side of register */}
        ...
        {/* Node.js - bottom right of register */}
        ...
        <div className="w-full max-w-md">
          <div className="bg-card/80 backdrop-blur-sm border border-border rounded-2xl p-8 shadow-2xl">
            <div className="text-center mb-6">
              <h1 className="text-2xl font-bold mb-2">Join BrickEnd</h1>
